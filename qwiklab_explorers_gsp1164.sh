...
echo "${MAGENTA_TEXT}${BOLD_TEXT}  Enforcing Public Access Prevention on the Bucket...${RESET_FORMAT}"
...
echo "${YELLOW_TEXT}${BOLD_TEXT}  Uploading 'findings.jsonl' to the Storage Bucket...${RESET_FORMAT}"
